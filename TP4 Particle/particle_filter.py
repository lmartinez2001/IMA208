...
class ParticleFilter(object):
    ...
    def resample(self, tau=None):
        ...
        if N_eff <= threshold:
            ...
            # Resample the particles according to their weights with numpy.random.choice
            indices=np.random.choice(self.n_particles, size=self.n_particles, replace=True, p=self.weights.flatten()) ####
